...
<div style="padding:10px 10px 10px 10px">
	...
	<div style="padding:5px">
		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitddmxEditForm()">提交</a>
		<a href="javascript:void(0)" class="easyui-linkbutton" onclick="clearddmxEditForm()">重置</a>
	</div>
</div>
<script type="text/javascript">
	//提交表单
	function submitddmxEditForm(){
		//有效性验证
		if(!$('#ddmxEditForm').form('validate')){
		...
		$.post("${pageContext.request.contextPath}/Dd/updateDdMx.do",$("#ddmxEditForm").serialize(), function(data){
			if(data.status == 200){
	...
	function clearddmxEditForm(){
		$('#ddmxEditForm').form('reset');
	}
