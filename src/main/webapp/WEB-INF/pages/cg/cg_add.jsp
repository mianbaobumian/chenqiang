...
<div style="padding:10px 10px 10px 10px">
	<form id="kcAddForm" class="kcForm" method="post">
	    <table cellpadding="5" >
	        <tr>
	            <td>商品名:</td>
	            <td colspan="10">
					<input id="cg" class="easyui-combogrid" name="cg"/>
	...
	<div style="padding:5px">
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="submitkcAddForm()">提交</a>
	    <a href="javascript:void(0)" class="easyui-linkbutton" onclick="clearkcAddForm()">重置</a>
	</div>
</div>
<script type="text/javascript">
	//提交表单
	function submitkcAddForm(){
		//有效性验证
		if(!$('#kcAddForm').form('validate')){
		...
		$.post("${pageContext.request.contextPath}/admin/Item/addItem.do",$("#kcAddForm").serialize(), function(data){
			if(data.status == 200){
	...
	function clearkcAddForm(){
		$('#kcAddForm').form('reset');
	}
