...
<table class="easyui-datagrid" id="userList" title="用户列表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'user_id',align:'center',width:150">用户编号</th>
            <th data-options="field:'username',align:'center',width:150">用户名</th>
            <th data-options="field:'user_type',align:'center',width:150">密码</th>
            <th data-options="field:'value_flag',width:150,align:'center',formatter:formatUserStatus">状态</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		$("#userList").datagrid({
	        ...
	        columns : [ [ 
				...
				{field : 'user_type', width : 150, title : '角色', align:'center',formatter:formatRole},
				{field : 'value_flag', width : 150, title : '状态', align:'center', formatter:formatUserStatus}
	        ] ],  
	    });
	}else{
		$("#userList").datagrid({  
